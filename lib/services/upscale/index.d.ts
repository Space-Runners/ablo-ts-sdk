...
export declare class UpscaleService {
     ...
     * @returns
     */
    fromUrl: (imageUrl: string, scale: number) => Promise<ISingleImageGenerationResponse>;
    /**
     ...
     * @returns
     */
    fromFile: (imageFile: File, scale: number) => Promise<ISingleImageGenerationResponse>;
}

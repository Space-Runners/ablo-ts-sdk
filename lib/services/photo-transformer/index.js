...
class PhotoTransformerService {
    constructor(axios, storageService) {
         ...
         */
        this.fromFile = (params, contentType, referenceImageContentType) => __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.fromUrl(Object.assign(Object.assign({}, params), { imageUrl: uploadUrl.split('?')[0], referenceImageUrl }));
            return response;
        });
        /**
